...
public class IconRequestActivity extends BaseSubActivity {
    ...
    static class RequestAdapter extends
        ...
        public void onBindViewHolder(
            ...
            if (App.getInstance().prefs().devOptionsOpened().getValue()) {
                holder.itemView.setOnLongClickListener(view -> {
                    new MaterialDialog.Builder(view.getContext())
                            .title("Component")
                            .content(mAppInfoList.get(realPos).getCode())
                            .show();
                    return true;
                });
            }
        ...
        static class AppItemViewHolder extends RecyclerView.ViewHolder {
            ...
            @BindView(R.id.linearLayout_icon_request_container)
