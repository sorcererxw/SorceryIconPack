...
public class Apply1Adapter extends RecyclerView.Adapter<Apply1Adapter.ApplyViewHolder> {
    ...
    public Apply1Adapter(Context context,
    ...
    public ApplyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ApplyViewHolder(LayoutInflater.from(mContext)
                .inflate(R.layout.item_apply_1, parent, false));
    }
