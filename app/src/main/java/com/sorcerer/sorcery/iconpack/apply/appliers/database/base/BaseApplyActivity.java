package com.sorcerer.sorcery.iconpack.apply.appliers.database.base;
...
public abstract class BaseApplyActivity extends AppCompatActivity {
        ...
        new RxPermissions(this)
                ...
                .subscribe(new Observer<List<String>>() {
                    ...
                    public void onSubscribe(Disposable d) {
                        ...
                        mDialog = Dialogs.indeterminateProgressDialog(mActivity, ResourceUtil
