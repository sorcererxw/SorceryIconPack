...
//            }
//        });
        ((TextView) convertView.findViewById(R.id.textView_lib_item_name)).setText(mLibList.get
                (position).getName());
        ((TextView) convertView.findViewById(R.id.textView_lib_item_author)).setText(mLibList.get
